...
4. `PHASE_2_REVIEW_CHECKLIST.md`
5. `06-phase-1-final-self-review.md`
6. `generated/phase-1-inventory.md`
7. `generated/phase-1-test-matrix.md`
8. `../../extracted/hermes-connect-kit/extraction-manifest.yaml`
9. `../../tests/extraction/snapshots/registry-snapshot.json`
...
The earlier split-root `vendor/compatibility/reference` runtime plan is superseded. The corrected implementation plan uses a complete staged projection, deterministic `projection-lock.json`, projected-root test execution, and five review checkpoints.

## Current execution state

- Latest upstream is merged into the isolated Phase 2 planning lineage.
- Design and implementation-plan corrections are documentation-only.

...
def parse_probe_output(stdout: str) -> RegistrySnapshot:
    ...
    return RegistrySnapshot(
        ...
        service_providers=_toolset_map(payload, "service_providers"),
        service_provider_builtins=_toolset_map(payload, "service_provider_builtins"),
        service_provider_plugins=_toolset_map(payload, "service_provider_plugins"),
